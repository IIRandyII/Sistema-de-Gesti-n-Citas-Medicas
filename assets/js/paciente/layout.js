// ============================================================
//  layout.js — Comportamiento del sidebar paciente
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (toggle && sidebar && main) {
    if (localStorage.getItem('paciente_sidebar_collapsed') === 'true') {
    ...
    toggle.addEventListener('click', function () {
      ...
      localStorage.setItem('paciente_sidebar_collapsed', sidebar.classList.contains('collapsed'));
    });
  }

<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="/CitaAgil1/pages/paciente/inicio.php"
       class="nav-item <?= $current_page === 'inicio' ? 'active' : '' ?>">
      <i class="ti ti-home"></i> Inicio
    </a>

    <div class="nav-label">Citas</div>
    <a href="/CitaAgil1/pages/paciente/buscar.php"
       class="nav-item <?= $current_page === 'buscar' ? 'active' : '' ?>">
      <i class="ti ti-search"></i> Buscar médico
    </a>
    <a href="/CitaAgil1/pages/paciente/citas.php"
  ...
  <header class="header">
    <div class="header-left">
      ...
      <div class="header-titles">
        <span class="header-title"><?= $page_title ?? 'Mi cuenta' ?></span>
